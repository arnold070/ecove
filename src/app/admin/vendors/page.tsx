                ...
                {vendors.map((v: import('@/types').Vendor) => {
                  ...
                  return (
                    <tr key={v.id} className="hover:bg-gray-50/50">
                      ...
                      <td className="px-5 py-4 text-sm font-bold" style={{ color: '#d4720e' }}>₦{Number(v.totalSales || 0).toLocaleString()}</td>
                      <td className="px-5 py-4 text-sm"><span className="text-yellow-400">★</span> {Number(v.averageRating || 0).toFixed(1)}</td>

        ...
        {vendor && (
          <div className="px-4 py-3 border-b border-white/10 shrink-0">
            <div className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-full overflow-hidden bg-white/10 flex items-center justify-center text-sm font-bold text-white shrink-0">
                {vendor.logoUrl ? <img src={vendor.logoUrl} alt="" className="w-full h-full object-cover" /> : vendor.businessName?.[0]}
              </div>

      ...
      <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden mb-6">
        ...
        <div className="px-5 pb-5">
          <div className="flex items-end gap-4 -mt-8 mb-4">
            <div className="w-16 h-16 rounded-full bg-white border-4 border-white shadow-md flex items-center justify-center text-2xl overflow-hidden shrink-0">
              {vendor?.logoUrl ? <img src={vendor.logoUrl} alt="" className="w-full h-full object-cover rounded-full" /> : vendor?.businessName?.[0]}
            </div>
            <div>

      ...
      <div className="grid lg:grid-cols-3 gap-8">
          ...
          {items.map(item => (
            <div key={item.id} className="bg-white rounded-2xl border border-gray-100 p-4 flex gap-4">
              ...
              <div className="flex flex-col items-end justify-between shrink-0">
                ...
                <div className="relative flex items-center border border-gray-200 rounded-xl overflow-hidden" role="group" aria-label={`Quantity for ${item.name}`}>
                  <button
        ...
        <div>
          <div className="bg-white rounded-2xl border border-gray-100 p-5 sticky top-24">
            ...
            <Link href="/checkout" className="block w-full py-3.5 rounded-xl bg-orange-500 hover:bg-orange-600 text-white font-bold text-sm text-center transition-colors">
              Proceed to Checkout →
            </Link>
